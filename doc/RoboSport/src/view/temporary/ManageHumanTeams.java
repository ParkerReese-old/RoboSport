...
public class ManageHumanTeams extends JPanel {
	...
	public ManageHumanTeams() {
        ...
        JLabel title = new JLabel("Manage Human Teams");
	...
	public static void main(String[] args) {
		JFrame window = SwingOps.newFrame(new ManageHumanTeams());
		window.setTitle("Manage Human Teams");
	}
}
