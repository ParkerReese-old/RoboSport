...
public class ManageRobots extends JPanel {
	...
	public ManageRobots() {
        ...
        gridBagLayout.rowWeights = new double[]{1,0,0,0,0};
        setLayout(gridBagLayout);
        
        JLabel title = new JLabel("Manage Robot Menu");
	...
	public static void main(String[] args) {
		JFrame window = SwingOps.newFrame(new ManageRobots());
		window.setTitle("Manage Robots");
	}
}
